...
-- attach to textclock such that calendar shows during mouse hover
...
-- {{{ Key bindings
-- TODO: consider remapping everything such that original key is used
-- j,k are harder to reach on neo than n,r for example
